 ...
 */
public class UserLicenseCollection extends IraCollection {
    ...
    public boolean haveLicense(String username, String license) {
        List<DBTable.DBData> dataList = this.getAllDataListData(new Document("username", username).append("license", license));
